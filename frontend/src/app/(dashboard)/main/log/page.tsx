                    ...
                    <td data-label="Metode:" className="p-4 flex justify-end md:table-cell text-right md:text-left ">
                      <span
                        className={`px-2 py-1 text-xs font-medium rounded-full ${
                          log.tag.includes('BAHAYA') ? 'bg-orange-800 text-gray-200' : log.tag.includes('MALWARE') ? 'bg-red-800 text-gray-200' : log.tag.includes('MENCURIGAKAN') ? 'bg-yellow-600 text-gray-200' : 'bg-blue-900 text-gray-200'
                        }`}
                      >
                        {log.metode}
                      </span>
