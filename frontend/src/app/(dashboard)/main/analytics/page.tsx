                ...
                {isFetchingDetails ? (
                  ...
                  <>
                    ...
                    <div className="mt-8 grid grid-cols-1 lg:grid-cols-1 gap-6">
                      {/* TABLE 1: MALWARE  */}
                      {(reportData?.logs.malware?.length ?? 0) > 0 && <LogTable title="Terdeteksi Malware" icon={<FaBiohazard size={18} className="text-red-600" />} logs={reportData?.logs.malware ?? []} bgColor="bg-gray-5/20" />}
